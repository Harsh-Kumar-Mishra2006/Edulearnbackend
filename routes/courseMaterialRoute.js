// courseMaterialRoute.js - FIXED VERSION
...
// File uploads - NO MULTER MIDDLEWARE (accepts JSON)
router.post('/courses/:course_id/videos', uploadVideoToCourse);
router.post('/courses/:course_id/documents', uploadDocumentToCourse);
